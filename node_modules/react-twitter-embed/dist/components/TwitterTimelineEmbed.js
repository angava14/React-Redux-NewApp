    ...
    value: function componentDidMount() {
      ...
      script.ready('twitter-embed', function () {
        ...
        if (_this2.props.theme) {
          options.theme = _this2.props.theme;
        }

        if (_this2.props.linkColor) {
          options.linkColor = _this2.props.linkColor;
        }

        if (_this2.props.borderColor) {
          options.borderColor = _this2.props.borderColor;
        }

        if (_this2.props.lang) {
          options.lang = _this2.props.lang;
        }

        /** Append chrome options */
        options.chrome = '';

        if (_this2.props.noHeader) {
          options.chrome = options.chrome + ' noheader';
        }

        if (_this2.props.noFooter) {
          options.chrome = options.chrome + ' nofooter';
        }

        if (_this2.props.noBorders) {
          options.chrome = options.chrome + ' noborders';
        }

        if (_this2.props.noScrollbar) {
          options.chrome = options.chrome + ' noscrollbar';
        }

        if (_this2.props.transparent) {
        ...
        if (!_this2.isMountCanceled) {
          window.twttr.widgets.createTimeline({
            ...
            id: _this2.props.id || _this2.props.widgetId,
...
TwitterTimelineEmbed.propTypes = {
   ...
   */
  linkColor: _propTypes2.default.string,
  /**
   ...
   */
  noBorders: _propTypes2.default.bool,
  /**
   * Hide the scrollbars
   */
  noScrollbar: _propTypes2.default.bool,
  /**
   * Enable Transparancy
   */
